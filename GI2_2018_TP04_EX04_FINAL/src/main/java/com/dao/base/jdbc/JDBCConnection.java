...
import com.bank.core.config.ConfigurationException;
...
public class JDBCConnection {
	...
	private JDBCConnection() throws DataAccessLayerException {
		...
		try {
			...
			dbProperties = ConfigurationLoader.getProperties();
	 ...
	 * @throws DataAccessLayerException
	 */
	public static Connection createUniqueConnexion() throws DataAccessLayerException {
		if (connection == null) {
			try {
				new JDBCConnection();
