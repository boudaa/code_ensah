...
/*
 * Définition d'une classe permettant de créer un thread avec la méthode par implémentation de l'interface Runnable (variante avec classe annonyme)s
 */
public class ByImplementingRunnableAsAnonymousClass {
