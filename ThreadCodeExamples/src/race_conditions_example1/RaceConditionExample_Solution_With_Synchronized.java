...
public class RaceConditionExample_Solution_With_Synchronized {

	private Compte[] banque = new Compte[] { new Compte(1, 2000), new Compte(2, 2000), new Compte(3, 2000) };

	public static void main(String[] args) {
		RaceConditionExample_Solution_With_Synchronized bank = new RaceConditionExample_Solution_With_Synchronized();
	...
	class TransferRunnable implements Runnable {
		...
		private RaceConditionExample_Solution_With_Synchronized banque;

		public TransferRunnable(RaceConditionExample_Solution_With_Synchronized banque) {
			this.banque = banque;
		}
