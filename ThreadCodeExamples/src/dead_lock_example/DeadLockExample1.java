...
public class DeadLockExample1 {
	...
	public static void main(String[] args) {
		DeadLockExample1 bank = new DeadLockExample1();
	...
	class TransferRunnable implements Runnable {
		...
		private DeadLockExample1 banque;
		int from, to;
		double montant;

		public TransferRunnable(DeadLockExample1 banque, int pFrom, int pTo, double pMontant) {
			this.banque = banque;
			from = pFrom;
			to = pTo;
			montant = pMontant;
